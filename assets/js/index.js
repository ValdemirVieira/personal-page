function handleMouseEnter() {
    this.classList.add('card-link--hovered');
    document.body.id = `${this.id}-hovered`;
}

function handleMouseLeave() {
    this.classList.remove('card-link--hovered');
    document.body.id = '';
}

function addEventListenersToCards() {
    const cardElements = document.getElementsByClassName('card-link');
...
function selectCarouselItem(selectedButtonElement) {
    ...
    const carousel = document.querySelector('.cards-carrosel');
